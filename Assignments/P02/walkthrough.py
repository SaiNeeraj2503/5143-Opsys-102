...
chmod_result = file_system.chmod(name="Folder3", permission="-w")
...
print("[bold blue]Command:[/bold blue] [green]chgrp group2 Folder3[/green]")
chgrp_result = file_system.chgrp(name="Folder3", group="group2")
file_system.add_history("chgrp group2 Folder3")
print(chgrp_result)
print()
time.sleep(1)
...
print("[bold blue]Command:[/bold blue] [green]touch files/treeout.json[/green]")
touch_result = file_system.touch(name="files/treeout.json")
file_system.add_history("touch files/treeout.json")
print(touch_result)
print()
time.sleep(1)
